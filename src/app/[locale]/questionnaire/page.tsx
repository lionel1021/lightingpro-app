...
export default function QuestionnairePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const budgetRange = budgetMapping[answers.budget] || [0, 9999]
      
      const questionnaireData = {
        room_type: answers.roomType || 'living',
        room_size: answers.roomSize || 'medium',
        style_preference: answers.style || 'modern',
        budget_min: budgetRange[0],
        budget_max: budgetRange[1],
        smart_features: false,
        lighting_needs: [],
        color_temperature: 'neutral',
        dimming_preference: false,
        installation_type: 'ceiling'
      }
      
      // Send questionnaire data to recommendations API
      ...
      if (data.success) {
        ...
        sessionStorage.setItem('lightingRecommendations', JSON.stringify(data.data))
