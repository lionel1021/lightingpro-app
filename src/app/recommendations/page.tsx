...
const mockProducts: LightingProduct[] = [
  {
    ...
    rating: 4.5,
    reviews: 1234,
    image: 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?w=400&h=300&fit=crop&crop=center',
  ...
  },
  {
    ...
    rating: 4.1,
    reviews: 542,
    image: 'https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=400&h=300&fit=crop&crop=center',
...
function RecommendationsContent() {
  ...
  const handlePurchaseClick = (product: LightingProduct, platform: string) => {
                ...
                <div className="w-full h-48 bg-gray-200 overflow-hidden">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'data:image/svg+xml;base64,';
                    }}
                  />
                </div>
                <button
