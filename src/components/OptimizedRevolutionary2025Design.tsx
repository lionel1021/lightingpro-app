  ...
  const elements = {
    neural: (
      <div className={`w-full h-full ${className} relative`}>
        ...
        <div className="absolute inset-2 border-3 border-white rounded-full animate-spin shadow-lg" 
             style={{ animationDuration: '3s' }} />
        <div className="absolute inset-4 bg-white rounded-full opacity-90 animate-pulse" />
      </div>
    ),
    quantum: (
      <div className={`relative ${className}`}>
        ...
        <div className="absolute inset-3 border-2 border-white/90 rounded-full animate-spin" style={{ animationDuration: '4s', animationDirection: 'reverse' }} />
        <div className="absolute inset-6 bg-white rounded-full opacity-95 animate-pulse" />
      </div>
    ),
    matrix: (
