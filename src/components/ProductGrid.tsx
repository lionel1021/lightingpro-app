        ...
        <div className={`grid gap-6 ${
          ...
          {paginatedProducts.map(product => (
            <ProductCard
              key={product.id}
              product={{
                id: parseInt(product.id.replace(/\D/g, ''), 10) || 0,
                name: product.name,
                ...
                isNew: typeof window !== 'undefined' && new Date(product.createdAt) > new Date(Date.now() - 30 * 24 * 60 * 60 * 1000),
                isHot: product.popularity > 80
              }}
